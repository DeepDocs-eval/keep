...
Certain permissions may be required to perform specific actions or queries via the provider. Below is a summary of relevant permissions and their use cases:
- **Mail Send**: Send emails using SendGrid (mandatory) ([Documentation](https://docs.sendgrid.com/ui/account-and-settings/api-keys))
